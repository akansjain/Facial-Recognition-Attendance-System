...
class Student:
    def __init__(self,root):
        ...
        f_lbl.place(x=500, y=00,width=420,height=150)
              
        #Background image 
        img3=Image.open(r"C:\Users\Akansha Jain\Desktop\Desktop\project\project\images\main background.jpg")
        img3 = Image.open(r"C:\Users\Akansha Jain\Desktop\Desktop\project\project\images\main background.jpg")
        img3 = Image.open(r"C:\Users\Akansha Jain\Desktop\Desktop\project\project\images\main background.jpg")
        ...
        bg_img.place(x=00, y=150,width=1530,height=730)


        title_lbl=Label(bg_img,text="STUDENT DETAILS MANAGE SECTION",font=("Algerian",30,"bold"),bg="white",fg="darkgreen")
        title_lbl.place(x=0, y=00, width=1530,height=30)


        main_frame=Frame(bg_img,bd=2,bg="white",)
        main_frame.place(x=20,y=35,width=1380,height=600)



        # left label frame
        left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Data Entry",font=("Algerian",12,"bold"))
        left_frame.place(x=5,y=5,width=670,height=515)
        img_left = Image.open(r"C:\Users\Akansha Jain\Desktop\Desktop\project\project\images\bgwhite.png")
...
#=========time============#
        ...
        lbl=Label(left_frame, font=('times new roman',14, 'bold'), foreground= 'blue')
        lbl.place(x=7,y=22,width=110,height=50)
        time()  
        ...
        #class divisonision
        class_divison_label=Label(class_student_frame,text="Class Division:",font=("times new roman",13,"bold"),bg="white")
        class_divison_label.grid(row=1,column=0,padx=10,pady=5,sticky=W)

        divison_combo=ttk.Combobox(class_student_frame,textvariable=self.var_divison,font=("times new roman",13,"bold"),state="readonly",width=16)
        divison_combo["values"]=("Select Division","A","B")
        divison_combo.current(0)
        divison_combo.grid(row=1,column=1,padx=10,pady=10,sticky=W)
       ...
       #button frame
        ...
        Right_frame1.place(x=680,y=5,width=650,height=515)

        #Search System
        search_frame=LabelFrame(Right_frame1,bd=2,bg="white",relief=RIDGE,text="Search System",font=("times new roman",12,"bold"))
        ...
        search_frame=LabelFrame(Right_frame1,bd=2,bg="white",relief=RIDGE,text="Search System",font=("Algerian",12,"bold"))
        search_frame.place(x=5,y=75,width=640,height=70)
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","divison","roll","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
#=================== get cursor ======================#
    ...
    def reset_data(self):
        ...
        self.var_divison.set("Select divison")
        self.var_roll.set("")
    ...
    def generate_dataset(self):
            if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
                ...
                try:
                    ...
                    casc_path = (r"C:\Users\Akansha Jain\Desktop\Desktop\project\project\haarcascade_frontalface_default.xml")
                    ...
                    while True:
                        ...
                        if face_cropped(my_frame) is not None:
                            ...
                            file_name_path="C:/Users/Akansha Jain/Desktop/Desktop/project/project/data/user."+str(id)+"."+str(img_id)+".jpg"
